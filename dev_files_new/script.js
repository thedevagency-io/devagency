// Scroll animations
  ...
  var serviceModalCloseBtn = document.getElementById('serviceModalClose');
  var serviceModalOverlayEl = document.getElementById('serviceModalOverlay');
  if (serviceModalCloseBtn) serviceModalCloseBtn.addEventListener('click', closeServiceModal);
  if (serviceModalOverlayEl) serviceModalOverlayEl.addEventListener('click', function(e) {
